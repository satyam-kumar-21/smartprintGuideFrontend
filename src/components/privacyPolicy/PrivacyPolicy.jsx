      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">
            Privacy Policy — Smart ePrinting
          </h1>
          <p className="mt-4 text-gray-600 text-base sm:text-lg leading-relaxed">
            Last Updated: January 31, 2026
          </p>
          <p className="mt-4 text-gray-600 text-base sm:text-lg leading-relaxed">
            Smart ePrinting (“Company,” “we,” “our,” “us”) is committed to protecting your personal information, ensuring transparency, and complying with all applicable privacy laws and consumer-protection regulations. By accessing or using our Website, you consent to the data practices described in this Privacy Policy.
          </p>
        </div>
