...
const HomePrinter = () => {
  ...
  const [filters, setFilters] = useState({
    ...
    brand: "",
    technology: [],
    usageCategory: ["Home"], // Always include 'Home'
    allInOneType: [],
    wireless: "",
    mainFunction: []
  });
  ...
  useEffect(() => {
    // Always include 'Home' in Usage Category
    const usageCategory = filters.usageCategory.includes("Home")
      ? filters.usageCategory
      : ["Home", ...filters.usageCategory];
  ...
  const handleFilterChange = (newFilters) => {
    ...
    setFilters({
      ...newFilters,
      usageCategory: newFilters.usageCategory.includes("Home")
        ? newFilters.usageCategory
        : ["Home", ...newFilters.usageCategory]
    });
  };
